...
<body>
    <form action="1Xulydangky.php" method="post" autocomplete="off">
        <div class="signup">
            ...
            <!-- <br><span id="check-username"></span> -->
            <input type="text" id="user" class="signup-input" placeholder="Eg: JohnDoe" name="user" onInput="checkUsername()">
            ...
            <label for="pollicy" class="signup-pollicy">
                <input type="radio" id="pollicy" class="signup-pollicy" name="pollicy" value="pollicy">Tôi đồng ý với
                Cityspace về <b>Điều khoản dịch vụ</b> <a>và</a> <b>Chính sách bảo mật</b></label>
