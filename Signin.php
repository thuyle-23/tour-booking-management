...
<body>
    <form action="1Xulydangnhap.php" method="post" autocomplete="off">
        <form method="POST">
            <div class="signin">
                ...
                <input type="text" class="signin-input" id="user" name="user" placeholder="Eg: JohnDoe" required>
                <label for="password" class="signin-label">Mật khẩu</label>
                <input type="password" id="password" class="signin-input" placeholder="abc123" name="pass" required>
                <button class="signin-submit" id="dangnhap" name="dangnhap">Đăng nhập</button>

                <p class="signin-enror">
                    <a href="validate_password.php" class="signin-enror-password">Đổi mật khẩu</a>
                </p>
