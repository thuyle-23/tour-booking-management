...
<div class="container-fluid al">
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#completeModal">Thêm khách
        hàng</button><Br><Br>
    <!-- Modal -->
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="updatepass" placeholder="Nhập mật khẩu">
                    </div>
                    <div class="form-group">
